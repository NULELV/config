...
#define BOARD_NAME        NULE_RACE_F7
#define MANUFACTURER_ID   NULE
...
#define BOX_USER2_NAME "LED PIN 2"
#define PINIO2_BOX 41
#define PINIO2_CONFIG 129
#define BOX_USER3_NAME "LED PIN 3"
